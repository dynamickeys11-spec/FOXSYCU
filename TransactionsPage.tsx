...
function printReceipt(t:Transaction){
 ...
 const rows=[
  ...
  ['To / From',normalizeFNCUBrand(meta.merchant||t.counterparty)||'—'],
  ['Account',meta.account_last4?`•••• ${meta.account_last4}`:'—'],
  ['Payment method',rail(t)],
  ['Reference',normalizeFNCUBrand(t.reference)||'—'],
  ['Fee',money(Number(t.fee||0))],
  ...(t.availableBalanceAfter!=null?[['Available balance',money(Number(t.availableBalanceAfter))]]:[])
 ]
