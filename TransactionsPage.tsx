...
function printReceipt(t:Transaction){
 ...
 const fromAccount=normalizeFNCUBrand(t.sourceAccount?.name||meta.sender_name||(t.direction==='debit'?'FNCU account':meta.merchant))||'—'
