...
function Loading(){return <main style={{minHeight:'100vh',display:'grid',placeItems:'center',fontFamily:'Inter,system-ui,sans-serif',background:'#F7F8FA',color:'#0B1220'}}><div style={{textAlign:'center'}}><strong style={{display:'block',fontSize:14,letterSpacing:'.08em'}}>FNCU</strong><span style={{display:'block',marginTop:6,fontSize:11,color:'#667085'}}>Loading your customer account…</span></div></main>}
