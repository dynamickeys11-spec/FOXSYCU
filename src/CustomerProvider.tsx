...
async function ensureCustomer(userId: string) {
  ...
  // mockData.ts is the canonical synthetic banking history. Supabase persists an exact customer-scoped copy.
